...
import { FaFileAlt, FaHandHoldingHeart, FaClock, FaCheckCircle, FaExclamationTriangle, FaArrowRight } from 'react-icons/fa';
  ...
  return (
    <div className="p-6 md:p-8">
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        ...
        <Card className="hover:shadow-xl transition-shadow cursor-pointer">
          <Link to="/aid-seeker/requests" className="block">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-xl font-semibold text-text-dark mb-2">
                  {t('aidSeeker.dashboard.createRequest', 'Create Aid Request')}
