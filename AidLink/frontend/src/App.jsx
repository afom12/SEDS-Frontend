...
const DonorMessages = React.lazy(() => import('./pages/donor/DonorMessages'));
const DonorNotifications = React.lazy(() => import('./pages/donor/DonorNotifications'));
...
const ReceiverMessages = React.lazy(() => import('./pages/receiver/ReceiverMessages'));
const ReceiverNotifications = React.lazy(() => import('./pages/receiver/ReceiverNotifications'));
